...
func TestNewClientWithBaseURL(t *testing.T) {
	...
	client := NewClientWithBaseURL(customURL, testutil.FakeAsanaToken, testutil.FakeAsanaWorkspaceID)
...
func TestNewClientWithBaseURL_TrimsTrailingSlash(t *testing.T) {
	client := NewClientWithBaseURL("https://custom.asana.test/", testutil.FakeAsanaToken, testutil.FakeAsanaWorkspaceID)
...
func TestGetTask(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if r.Header.Get("Authorization") != "Bearer "+testutil.FakeAsanaToken {
