...
func ConvertWorkItemToTask(wi *WorkItem, organization, project, repository, baseURL string) *TaskInfo {
	return convertWorkItemToTask(wi, organization, project, repository, baseURL, slog.Default())
}

// ConvertWorkItemToTaskWithLogger converts an Azure DevOps work item to a TaskInfo using the provided logger
func ConvertWorkItemToTaskWithLogger(wi *WorkItem, organization, project, repository, baseURL string, logger *slog.Logger) *TaskInfo {
	return convertWorkItemToTask(wi, organization, project, repository, baseURL, logger)
}

func convertWorkItemToTask(wi *WorkItem, organization, project, repository, baseURL string, logger *slog.Logger) *TaskInfo {
	// Construct clone URL
